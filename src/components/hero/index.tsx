...
function Hero() {
	return (
		<section className="dark:bg-[#1b1b1c] h-screen sm:min-h-[600px] overflow-x-hidden sm:h-screen md:max-h-[800px] lg:max-h-[900px] xl:max-h-[900px] overflow-scroll relative flex flex-col justify-center flex-wrap items-center  ">
